...
<div>
    ...
    <ul>
        ...
        <li>🔍 관심 분야: LLM, Computer Vision, 빅데이터, 웹 개발, IoT, UAV</li>
        <li>📝 배우고 실험한 내용을 체계적으로 정리하는 것을 즐깁니다</li>
    </ul>
</div>
...
<div>
    ...
    <img src="https://img.shields.io/badge/fastapi-009688.svg?style=for-the-badge&logo=fastapi&logoColor=FFFFFF" alt="fastapi" />
    <img src="https://img.shields.io/badge/django-092E20.svg?style=for-the-badge&logo=django&logoColor=FFFFFF" alt="django" />
...
<div>
    ...
    <ul>
        ...
        <li><strong>🍽 테이블 예약과 단골 맞춤형 쿠폰 서비스</strong> (2022.08)<br><em>Python, Kakao Map API, 빅데이터</em><br>2022 제주스마트관광 빅데이터 해커톤</li>
    </ul>
</div>
